% MODEL 2: referenceArea = blade AREA, blade velo =
% (rpm/60)*2*pi*(bladeDiameter/2) -> OUTERMOST VELO
...
velo = (rpm/60)*2*pi*(bladeDiameter/2); % Not sure if angular velo or avg velo or get all sep lifts and add them

bladeWidth = 0.33528;
% pi*((bladeDiameter/2)^2)
referenceArea = bladeWidth*bladeDiameter;
